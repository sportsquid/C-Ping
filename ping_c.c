...
int main(int argc, char *argv[]){
	...
	ip_header.source_ip = inet_addr("192.168.50.215");
	ip_header.destination_ip = inet_addr("8.8.8.8");
	...
	if(sendto(raw_socket, packet, sizeof(struct ip_packet) + sizeof(struct icmp_packet), 0, (struct sockaddr *) &dest_addr, sizeof(dest_addr)) < 0) {
